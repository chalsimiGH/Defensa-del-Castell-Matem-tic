    ...
    switch (item.type) {
      ...
      case 'decoration':
        switch (item.value) {
          ...
          // Use imported High-Quality Visuals
          case 'dragon': return <div className="scale-75 origin-center"><DragonVisual /></div>;
          case 'crystal': return <div className="scale-75 origin-center"><CrystalVisual /></div>;
